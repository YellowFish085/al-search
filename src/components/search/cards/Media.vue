<template>
  ...
  <div v-if="data" class="card card--media" :style="{ '--media-color': data.coverImage.color }">
    ...
    <div class="card__data">
      <div v-if="countdown" class="card__data__airing-countdown">
        <span>{{ countdown }}</span>
      </div>
      <div class="card__data__extra">
        <div class="card__data__extra__format"><span>{{ data.format }}</span></div>
        <div class="card__data__extra__score"><span>{{ data.averageScore }}%</span></div>
      </div>
      <div class="card__data__description" v-html="data.description"></div>
      <div class="card__data__genres w-full">
        <span v-for="genre in data.genres" :key="genre">{{ genre }} , </span>
      </div>
    </div>
  </div>
  <!-- Placeholder -->
  <div v-else class="card card--media card--placeholder">
    <div class="card--placeholder__cover"></div>
    <div class="card--placeholder__data">
      <div class="card--placeholder__block card--placeholder__block--big"></div>
      <div class="card--placeholder__block card--placeholder__block--medium"></div>
      <div class="card--placeholder__block card--placeholder__block--medium"></div>
      <div class="card--placeholder__block card--placeholder__block--small"></div>
      <div class="card--placeholder__block card--placeholder__block--small"></div>
    </div>
  </div>
