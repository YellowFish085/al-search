      ...
      <transition name="translate">
        ...
        <div v-if="accessToken && user" key="logged-in" class="logged-in">
          ...
          <div class="row row--justify-between row--items-center">
            <p>Login out here will not remove the access token generated by <b>AniList</b>. Please go to your <a href="https://anilist.co/settings/apps" title="Open your settings page"><strong>Settings > Apps</strong></a> page and revoke the <b>Ani-Search</b> app for a complete logout.</p>
          </div>
        </div>
